...
?>
 <form class="form-horizontal span6" action="controller.php?action=add" method="POST">
                ...
                <div class="row">
                   <div class="col-lg-12">
                      <h1 class="page-header">Add New Country/City</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                 </div> 
                  ...
                  <div class="form-group">
                    <div class="col-md-8">
                      ...
                      "COMPANYNAME">Country/City Name:</label>

                      <div class="col-md-8">
                         <input class="form-control input-sm" id="COMPANYNAME" name="COMPANYNAME" placeholder=
                            "Country Name" type="text" value="" autocomplete="none">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="col-md-8">
                      <label class="col-md-4 control-label" for=
                      "COMPANYADDRESS">Country Address/City:</label> 
                      <div class="col-md-8">
                        <textarea class="form-control input-sm" id="COMPANYADDRESS" name="COMPANYADDRESS" placeholder=
                            "Country Address/City" type="text" value="" required  onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off"></textarea>
