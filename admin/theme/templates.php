...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo web_root;?>/admin/" class="logo">
      ...
      <span class="logo-mini"><b>Mahamud Agency</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Loju global Agency ltd</b></span>
    </a>
 ...
 <div class="modal fade" id="menuModal" tabindex="-1">
      ...
      <ul class="sidebar-menu"> 
        ...
        <li class="<?php echo (currentpage() == 'company') ? "active" : false;?>" >
          <a href="<?php echo web_root ;?>admin/company/">
            <i class="fa fa-building"></i> <span>Countries</span> 
          </a>
        </li>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2021 <a href="www.molbstech.com">Molbs Tech</a>.</strong> All rights
    reserved.
  </footer>
