...
<head>
<meta charset="utf-8">
<title>LOJU GLOBAL AGENCY/ <?php echo $title;?></title>
<meta name="viewport" content="width=device-width, initial-scale=1.0" />
<meta name="description" content="" />
<meta name="author" content="http://webthemez.com" />
<link rel="shortcut icon" href="plugins/home-plugins/img/loju.jpeg" type="image/x-icon" />
    <link rel="apple-touch-icon" href="plugins/home-plugins/img/loju.jpeg">
  ...
  <header>
        <div class="topbar navbar-fixed-top">
          <div class="container">
            <div class="row">
              <div class="col-md-12">      
                <p class="pull-left hidden-xs"><i class="fa fa-phone"></i>Tel No. +254 724 874026 / +254724 427675</p>
        ...
        <div class="navbar navbar-default navbar-static-top" > 
            <div class="container">
                <div class="navbar-header">
                    ...
                    <img src="plugins/home-plugins/img/loju.jpeg" alt="logo" width="150" height="65" title="Logo of a company" alt="Logo of a company" /><!-- <img src="<?php echo web_root; ?>plugins\home-plugins\img\Mahamud.png" alt="logo" width="170" height="60" title="Logo of a company" alt="Logo of a company/> --></a>
                </div>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                          ...
                          <ul class="dropdown-menu">
                              ...
                              <li><a href="<?php echo web_root; ?>index.php?q=search-company">Job By Country/City</a></li>
                              <li><a href="<?php echo web_root; ?>index.php?q=search-function">Job By Category</a></li>
                      ...
                      <li class="dropdown <?php  if(isset($_GET['q'])) { if($_GET['q']=='category'){ echo 'active'; }else{ echo ''; }}  ?>">
                          <a href="#" data-toggle="dropdown" class="dropdown-toggle">Job Categories <b class="caret"></b></a>
                          <ul class="dropdown-menu">
                            <?php 
                        ...
                        <li class="<?php  if(isset($_GET['q'])) { if($_GET['q']=='company'){ echo 'active'; }else{ echo ''; }}  ?>"><a href="<?php echo web_root; ?>index.php?q=company">Countries/Cities</a></li>
    ...
    <div class="row">
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          Tyme Arcade, 4th floor, Suite 414,<br>
          Ongata Rongai, Magadi Road.</address>
          <p>
            <i class="icon-phone"></i>+254 724 874026 / +254724 427675 <br>
            <i class="icon-envelope-alt"></i> mgalimitedco@gmail.com
          </p>
        </div>
      </div>
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          <ul class="link-list">
            ...
            <li><a href="<?php echo web_root; ?>index.php?q=company">Countries/Cities</a></li>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="copyright">
            <p>
              <span>&copy; Designed by Molbs Tech 2021 All rights reserved.  
            </p>
          </div>
        </div>
        <div class="col-lg-6">
