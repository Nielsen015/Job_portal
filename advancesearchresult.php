						...
						<div class="pull-left">
							<div class="btn-group">
								...
								switch ($searchfor) {
									case 'bycompany':
										# code...
									echo 'Result : '  . $search . ' | Country/City : ' . $company;
										break;
									case 'advancesearch':
										# code... 
									echo 'Result : '  . $search . ' | Country/City : ' . $company . ' | Function : ' . $category; 
									    break;
									case 'byfunction':
										# code... 
											...
											<div class="media">
												...
												<div class="media-body">
													...
													<h4 class="title">
														...
														<span class="pull-right pagado">(Country/City <?php echo $row->COMPANYNAME ?>)</span>
													</h4>
